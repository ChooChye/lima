...
$count->bindParam(":userid",$_SESSION['admin_userid'],PDO::PARAM_STR, 15);
$count->execute();
...
$sql=$dbo->prepare("update client_login set password=:password where userid='$_SESSION[admin_userid]'");
