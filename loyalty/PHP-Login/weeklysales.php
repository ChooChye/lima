...
function validate()
{
   if( document.form.WeekNo.value == "" )
   {
     alert( "Please enter week no.!" );
     document.form.WeekNo.focus() ;
     return false;
   }
   ...
   if( document.form.Fr.value == "" )
   {
     alert( "Please fill up From Field!" );
     document.form.Fr.focus() ;
     return false;
   }
   if( document.form.T.value == "" )
   {
     alert( "Please fill up To field!" );
     document.form.T.focus() ;
     return false;
   }
  ...
  if( document.form.ODed.value == "" )
   ...
   if( document.form.ONet.value == "" )
   {
     ...
     return false;
       ...
       if( document.form.TNos.value == "" )
   {
     alert( "Please provide No. of Sales (Total)!" );
     document.form.TNos.focus() ;
     return false;
   }
   if( document.form.TGross.value == "" )
   {
     alert( "Please fill up Total Gross field!" );
     document.form.TGross.focus() ;
     return false;
   }
  if( document.form.TDed.value == "" )
   {
     alert( "Please fill up Total Deduct field!" );
     document.form.TDed.focus() ;
     return false;
   }
   if( document.form.TNet.value == "" )
   {
     alert( "Please fill up Total Net filed!" );
     document.form.TNet.focus() ;
     return false;
   }
...
echo "<center><font face='Verdana' size='2' color=white>Sorry, Please <a href=../index.php style='color: #ff0000'>login</a> to use this page </font></center>";
exit;
}else{
...
<h2 align="center" class="style1">Weekly Sales Report</h2>

<div align="center">
<th scope="col"><form enctype="multipart/form-data" [ccc] action="upload_to_sql.php" method="POST" name="form" onsubmit="return(validate());">
  <table width="415" border="1">
  <tr>
    <td width="436"><span class="style3">WEEKLY SALES REPORT - WEEK # </span> <input type="text" name="WeekNo" size="1" />&nbsp;&nbsp;<span class="style3">Date</span> <input type="text" name="Date" size="5" /></td>
  </tr>
</table>
<table width="415" border="1">
  <tr>
    <td width="218"><span class="style1">From </span> 
      <input type="text" name="Fr" size="9" />
	  <span class="style1">To </span>
	  <input type="text" name="T" size="9" />
      </td>
    <td width="160"><span class="style1">Program Code </span> 
      <input name="ProgramCode" type="text" size="7" /></td>
  </tr>
</table><table width="415" border="1">
  <tr>
    <td width="65"><span class="style1">Item</span></td>
    <td width="62"><div align="center"><span class="style1">Nos</span></div></td>
    <td width="62"><div align="center"><span class="style1">Gross</span></div></td>
    <td width="120"><div align="center"><span class="style1">Deduct</span></div></td>
    <td width="72"><div align="center"><span class="style1">Net</span></div></td>
  </tr>
  <tr>
    <td><span class="style1">Visa</span></td>
    <td><input name="VNos" type="text" size="6"/></td>
    <td><input name="VGross" type="text"size="6"/></td>
    <td><input name="VDed" type="text"size="15"/></td>
  ...
  <tr>
    ...
    <td><input name="MDed" type="text"size="15"/></td>
  ...
  <tr>
    ...
    <td><input name="ADed" type="text"size="15"/></td>
  ...
  <tr>
    ...
    <td><input name="DDed" type="text"size="15"/></td>
  ...
  <tr>
    ...
    <td><input name="CHDed" type="text"size="15"/></td>
  ...
  <tr>
    ...
    <td><input name="CADed" type="text"size="15"/></td>
    <td><input name="CANet" type="text"size="7"/></td>
  </tr>
    <tr>
    <td><span class="style1">Others</span></td>
    <td><input name="ONos" type="text"size="6"/></td>
    <td><input name="OGross" type="text"size="6"/></td>
    <td><input name="ODed" type="text"size="15"/></td>
    <td><input name="ONet" type="text"size="7"/></td>
  </tr>
  <tr>
    <td><span class="style3">TOTAL</span></td>
    <td><input name="TNos" type="text"size="6"/></td>
    <td><input name="TGross" type="text"size="6"/></td>
    <td><input name="TDed" type="text"size="15"/></td>
