                        ...
                        <div class="panel-body p-none">
                            <table class="table data-table table-hover table-ultra-responsive">
                                ...
                                <tr>
                                    ...
                                    <th class="text-right"><?php echo e(language_data('Actions')); ?></th>
                                </tr>
                                </thead>
                                <tbody>

                                <?php foreach($st as $in): ?>
                                    <tr>
                                        <td><a href="<?php echo e(url('employee/support-tickets/view-ticket/'.$in->id)); ?>"><?php echo e($in->id); ?></a> </td>
                                        ...
                                        <td class="text-right">
                                            <a href="<?php echo e(url('employee/support-tickets/view-ticket/'.$in->id)); ?>" class="btn btn-success btn-xs"><i class="fa fa-eye"></i> <?php echo e(language_data('View')); ?></a>
                                            </td>
                                    </tr>
                                <?php endforeach; ?>
