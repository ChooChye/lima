                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="tab-content p-20">
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="ticket_discussion">
                                            <form method="POST" action="<?php echo e(url('employee/support-tickets/replay-ticket')); ?>">
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="ticket_files">
                                            <form role="form" method="post" action="<?php echo e(url('employee/support-ticket/post-ticket-files')); ?>" enctype="multipart/form-data">
                                            ...
                                            <table class="table table-hover">
                                                <thead>
                                                <tr>
                                                    <th style="width: 25%;"><?php echo e(language_data('Files')); ?></th>
                                                ...
                                                <?php foreach($ticket_file as $tf): ?>
                                                    <tr>
                                                        ...
                                                        <td data-label="Upload by"><p><?php echo e(get_date_format($tf->updated_at)); ?></p></td>
                                                        ...
                                                        <td data-label="actions" class="text-right">
                                                            <a href="<?php echo e(url('employee/support-ticket/download-file/'.$tf->id)); ?>" class="btn btn-success btn-xs"><i class="fa fa-download"></i> </a>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                                                </tbody>
