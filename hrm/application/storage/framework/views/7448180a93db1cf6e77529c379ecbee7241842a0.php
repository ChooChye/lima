        ...
        <div class="p-30 p-t-none p-b-none">
                    ...
                    <td class="p-l-100">
                        <table class="table table-condensed table-transparent table-condensed-slim table-bordered">
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <span><?php echo e(app_config('Currency')); ?> <?php echo e($payslip->employee_info->working_hourly_rate); ?></span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td class="text-right">
                                    <span><?php echo e(app_config('Currency')); ?> <?php echo e($payslip->employee_info->overtime_hourly_rate); ?></span>
                                </td>
                            </tr>
                        </table>
                    </td>
            ...
            <table class="table table-condensed table-transparent table-condensed-slim table-bordered">
                ...
                <tr>
                    ...
                    <td align="right" class="td-b-l-none">$ 0</td>
                </tr>
