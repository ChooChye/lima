			...
			<div class="p-30">
				<div class="row">
					...
					<div class="col-sm-4 text-right">
                        <a href="<?php echo e(url('employee/payslip/print-payslip/'.$payslip->id)); ?>" target="_blank" class="btn btn-primary btn-animated from-left fa fa-print">
					...
					<div class="panel">
						...
						<div class="panel-body p-none">
							<table class="table table-condensed">
								<tbody>
									<tr>
										<td><strong><?php echo e(language_data('Working Hourly Rate')); ?>:</strong> <span class="pull-right"><?php echo e(app_config('Currency')); ?> <?php echo e($payslip->employee_info->working_hourly_rate); ?></span></td>
									</tr>
									<tr>
										<td><strong><?php echo e(language_data('Overtime Hourly Rate')); ?>:</strong> <span class="pull-right"><?php echo e(app_config('Currency')); ?> <?php echo e($payslip->employee_info->overtime_hourly_rate); ?></span></td>
									</tr>
								</tbody>
							</table>
						</div>
