                        ...
                        <div class="panel-body">
                            ...
                            <form class="" role="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" readonly class="form-control" value="<?php echo e($task->progress); ?>">
                                </div>


                                <div class="form-group m-none">
                                    <label for="e20"><?php echo e(language_data('Status')); ?></label>
                                    <input type="text" readonly class="form-control" value="<?php echo e($task->status); ?>">
                                </div>
                            </form>
                        </div>
                    </div>
                                    ...
                                    <div class="tab-content p-20">
                                        ...
                                        <div role="tabpanel" class="tab-pane active" id="task_details">
                                            ...
                                            <?php foreach($task_employee as $te): ?>
                                                <?php echo e($te->emp_name); ?><br>
                                            <?php endforeach; ?>
                                        </div>


                                        <div role="tabpanel" class="tab-pane" id="task_discussion">
                                            <form role="form" method="post" action="<?php echo e(url('employee/task/post-task-comments')); ?>">
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="task_files">
                                            <form role="form" method="post" action="<?php echo e(url('employee/task/post-task-files')); ?>"
                                                        ...
                                                        <div class="input-group input-group-file">
                                                            <span class="input-group-btn">
                                                                <span class="btn btn-primary btn-file">
                                                                    Browse <input type="file" class="form-control" name="file">
                                                                </span>
                                                            </span>
                                            ...
                                            <table class="table table-hover">
                                                ...
                                                <?php foreach($task_files as $tf): ?>
                                                    <tr>
                                                        ...
                                                        <td data-label="Size"><p>
                                                        <?php echo e(round($tf->file_size/1000,2)); ?> KB
                                                        </p></td>
                                                        ...
                                                        <td data-label="Member"><p><?php echo e($tf->employee_name->fname); ?>
                                                                ...
                                                                <?php /*<span class="label label-success"> <?php echo e($tf->employee_name->role); ?></span></p></td>*/ ?>

                                                        <td data-label="actions">
                                                            <a href="<?php echo e(url('employee/task/download-file/'.$tf->id)); ?>" class="btn btn-success btn-xs"><i class="fa fa-download"></i> </a>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                                                </tbody>
