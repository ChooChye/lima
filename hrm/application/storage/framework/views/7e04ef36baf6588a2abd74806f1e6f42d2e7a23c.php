...
<html lang="en">
<meta charset="UTF-8">
<title><?php echo e(app_config('AppName')); ?> - <?php echo e(language_data('Salary Statement')); ?></title>
    ...
    <div class="container container-printable">
        <div class="p-30 p-t-none p-b-none">
            ...
            <table width="100%">
                ...
                <tr>
                    <td style="border: 0;  text-align: left" width="62%">
                        <span style="font-size: 18px;"><strong><?php echo e(language_data('Salary Statement')); ?></strong></span>
                        <br>
                        <span><strong><?php echo e(language_data('Date')); ?>:</strong> <?php echo e(get_date_format(date('Y-m-d'))); ?></span>
                    </td>
                ...
                <tr>
                    ...
                    <td class="p-l-100">
                        <table class="table table-condensed table-transparent table-condensed-slim table-bordered">
                            <tr>
                                <td>
                                    <strong><?php echo e(language_data('Date From')); ?> :</strong>
                                </td>
                                <td class="text-right">
                                    <span><?php echo e(get_date_format($date_from)); ?></span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <strong><?php echo e(language_data('Date To')); ?> :</strong>
                                </td>
                                <td class="text-right">
                                    <span><?php echo e(get_date_format($date_to)); ?></span>
                                </td>
                            </tr>
            ...
            <table class="table table-condensed table-transparent table-condensed-slim table-bordered">
                ...
                <tr class="item-row">
                    <td class="description"><?php echo e($p->payment_month); ?></td>
                    <td align="right" colspan="3"><?php echo e(app_config('CurrencyCode')); ?> <?php echo e($p->total_salary); ?></td>
                </tr>
                <?php endforeach; ?>

                <tr>
                    <td class="td-b-none"></td>
                    <td align="right" colspan="2" class="td-b-r-none"><?php echo e(language_data('Net Salary')); ?></td>
                    <td align="right" class="td-b-l-none"><?php echo e(app_config('CurrencyCode')); ?> <?php echo e($net_salary); ?></td>
                </tr>

                <tr>
                    <td class="td-b-none"></td>
                    <td align="right" colspan="2" class="td-b-r-none"><?php echo e(language_data('Overtime Amount')); ?></td>
                    <td align="right" class="td-b-l-none"><?php echo e(app_config('CurrencyCode')); ?> <?php echo e($over_time); ?></td>
                </tr>

                <tr>
                    <td class="td-b-none"></td>
                    <td align="right" colspan="2" class="td-b-r-none"><?php echo e(language_data('TAX')); ?></td>
                    <td align="right" class="td-b-l-none">(-) <?php echo e(app_config('CurrencyCode')); ?> <?php echo e($tax); ?></td>
                </tr>

                <tr>
                    <td class="td-b-none"></td>
                    <td align="right" colspan="2" class="td-b-r-none"><?php echo e(language_data('Provident Fund')); ?></td>
                    <td align="right" class="td-b-l-none">(-) <?php echo e(app_config('CurrencyCode')); ?> <?php echo e($provident_fund); ?></td>
                </tr>

                <tr>
                    <td class="td-b-none"></td>
                    <td align="right" colspan="2" class="td-b-r-none"><?php echo e(language_data('Loan')); ?></td>
                    <td align="right" class="td-b-l-none">(-) <?php echo e(app_config('CurrencyCode')); ?> <?php echo e($loan); ?></td>
                </tr>
                ...
                <tr>
                    ...
                    <td align="right" class="td-b-l-none"><?php echo e(app_config('CurrencyCode')); ?> <?php echo e($total_salary); ?></td>
                </tr>
