                            ...
                            <table class="table data-table table-hover table-ultra-responsive">
                                ...
                                <tr>
                                    ...
                                    <td data-label="Actions">
                                        ...
                                        <a class="btn btn-success btn-xs" href="#" data-toggle="modal" data-target=".modal_set_job_applicant_status_<?php echo e($d->id); ?>"><i class="fa fa-edit"></i> <?php echo e(language_data('Status')); ?></a>
                                        <?php echo $__env->make('admin.modal-set-status-applicant', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
