...
<?php $__env->startSection('content'); ?>
    ...
    <section class="wrapper-bottom-sec">
        <div class="p-30">
            <h2 class="page-title"><?php echo e(language_data('Employee Roles')); ?></h2>
        </div>
        <div class="p-30 p-t-none p-b-none">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="panel">
                        <div class="panel-body">
                            <form class="" role="form" method="post" action="<?php echo e(url('employees/add-roles')); ?>">
                                <div class="panel-heading">
                                    <h3 class="panel-title"> <?php echo e(language_data('Add')); ?> <?php echo e(language_data('Employee Roles')); ?></h3>
                                </div>
                ...
                <div class="col-lg-8">
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title"><?php echo e(language_data('Employee Roles')); ?></h3>
                        </div>
                        <div class="panel-body p-none">
                            <table class="table data-table table-hover table-ultra-responsive">
                                ...
                                <tr>
                                    ...
                                    <th style="width: 40%;"><?php echo e(language_data('Role Name')); ?></th>
                                    <th style="width: 15%;"><?php echo e(language_data('Status')); ?></th>
                                    <th style="width: 35%;"><?php echo e(language_data('Actions')); ?></th>
                                </tr>
                                </thead>
                                <tbody>
                                <?php foreach($emp_roles as $er): ?>
                                <tr>
                                    <td data-label="SL"><?php echo e($er->id); ?></td>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-success btn-xs" href="#" data-toggle="modal" data-target=".modal_edit_employee_roles_<?php echo e($er->id); ?>"><i class="fa fa-edit"></i> <?php echo e(language_data('Edit')); ?></a>
                                        <?php echo $__env->make('admin.modal-edit-employee-roles', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                        <a class="btn btn-complete btn-xs" href="<?php echo e(url('employees/set-roles/'.$er->id)); ?>"><i class="fa fa-list"></i> <?php echo e(language_data('Set Roles')); ?></a>
