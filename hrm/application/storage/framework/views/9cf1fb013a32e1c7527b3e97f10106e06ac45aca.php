                            ...
                            <table class="table data-table table-hover table-ultra-responsive">
                                ...
                                <tr>
                                    ...
                                    <td data-label="Actions">
                                        ...
                                        <a class="btn btn-success btn-xs" href="<?php echo e(url('employee/loan/view-details/'.$l->id)); ?>" ><i class="fa fa-edit"></i> <?php echo e(language_data('Edit')); ?></a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
            ...
            <div class="modal fade" id="add-load" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form class="form-some-up" role="form" method="post" action="<?php echo e(url('employee/loan/post-new-loan')); ?>">
