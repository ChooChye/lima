...
<?php $__env->startSection('content'); ?>
    ...
    <section class="wrapper-bottom-sec">
        <div class="p-30">
            <h2 class="page-title"><?php echo e(language_data('Employee Salary Increment')); ?></h2>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title"><?php echo e(language_data('Employee Salary Increment')); ?></h3>
                        </div>
                        <div class="panel-body p-none">
                            <table class="table data-table table-hover table-ultra-responsive">
                                ...
                                <tr>
                                    ...
                                    <td data-label="working_hourly_rate"><p><?php echo e($d->payment_type); ?></p></td>
                                    <td data-label="Actions" class="text-right">
                                        <a class="btn btn-success btn-xs" href="<?php echo e(url('payroll/employee-salary-increment-edit/'.$d->id)); ?>" ><i class="fa fa-edit"></i> <?php echo e(language_data('Edit')); ?></a>
                                    </td>
                                </tr>
